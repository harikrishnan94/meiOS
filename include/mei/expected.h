...
#define Try(e)                                                                    \
  ({                                                                              \
    auto &&mei_expected_tmp = (e);                                                \
    static_assert(tl::detail::is_expected<decltype(mei_expected_tmp)>::value,     \
                  "TRY requires an expected object");                             \
    if (!mei_expected_tmp) return mei::make_unexpected(mei_expected_tmp.error()); \
    std::move(mei_expected_tmp);                                                  \
  }).value()
